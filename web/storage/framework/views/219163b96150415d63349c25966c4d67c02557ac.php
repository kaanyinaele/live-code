    ...
    <div class="box bo-co float">
      <div class="box-body" >
        <div class="col-xs-12 from-lex">
         <form action="<?php echo e(route('user_search')); ?>" method="POST" class="from-bpox-in" >
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <a href="<?php echo e(route('add/user')); ?>"  style="float: right;margin-top: -23px">
                 ...
                 <!--  <td><?php echo e($data->address); ?></td> -->
                  ...
                  <td>
                    <?php if(!empty($data->image)): ?>
                      <a href="<?php echo e(asset('public/image/users/'.$data->image)); ?>">
                        <img src="<?php echo e(asset('public/image/users/'.$data->image)); ?>" height="50px" width="50px" class="img-circle">
                      </a>
                    <?php else: ?>
                     <a href="<?php echo e(asset('public/user.png')); ?>">
                      <img src="<?php echo e(asset('public/user.png')); ?>" height="50px" width="50px" class="img-circle">
                      </a>
                    <?php endif; ?>
                  </td>
                  <td>
                  ...
                  <td>
                    <?php if($data->status == '0'): ?>
                      <a class="btn btn-success btn-sm" onclick="return confirm('Are you sure, you want to de-active this user?')" href="<?php echo e(route('users/status',[$data->id,$data->status])); ?>" title="Deactive User">
                        <i class="fa fa-lock"></i> Active
                      </a>
                    <?php endif; ?>  
                    <?php if($data->status == '1'): ?>
                      <a class="btn btn-warning btn-sm" onclick="return confirm('Are you sure, you want to Active this user?');" href="<?php echo e(route('users/status',[$data->id,$data->status])); ?>" title="Active User">
                        <i class="fa fa-unlock-alt"></i> De-Active
                      </a>
                    <?php endif; ?>
                  </td>
                  <td>
                   <?php if($data->account_activate == 0): ?> 
                  ...
                  <td>
                    <center>
                      <form method="POST" action="<?php echo e(route('delete/user',[$data->id,$page])); ?>" class="form-inline">
                        <a href="<?php echo e(route('view/appointment',base64_encode($data->id))); ?>" class="btn btn-success btn-sm">
                         appointment
                        </a>
                        <a href="<?php echo e(route('view/user',base64_encode($data->id))); ?>" class="btn btn-success btn-sm">
                          <i class="glyphicon glyphicon-eye-open"></i>
                        </a>
                        <a href="<?php echo e(route('edit/user',[base64_encode($data->id),$page])); ?>" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ogaworkmen/public_html/resources/views/admin/user/UserList.blade.php ENDPATH**/ ?>