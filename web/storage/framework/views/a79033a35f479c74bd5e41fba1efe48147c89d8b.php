                ...
                <tr>
                  <td><?php echo e(booking_service($data->service_id)); ?></td>
                    ...
                    <!--   <td><?php echo e($data->payment_type); ?></td> -->
                      ...
                      <td> <a href="<?php echo e(asset('public/image/book_service/'.$data->image)); ?>"><img src="<?php echo e(asset('public/image/book_service/'.$data->image)); ?>" height="50" width="40px"></a> </td>
                       <td>
                       <?php
                    ...
                    <td>
                     ...
                     <?php $__currentLoopData = $store; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $display): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <td><?php echo e($data->price); ?>

                      </td>
                      <td><?php if(empty($data->assign_provider)): ?> <a class="btn btn-danger">No Responce</a>
                        <?php else: ?> <?php echo e(provider_name($data->assign_provider)); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ogaworkmen/public_html/resources/views/admin/booking/view.blade.php ENDPATH**/ ?>