      ...
      <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="cat-head">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a href="javascript:void(0);" class="dropdown-item open_modal" data-id="<?php echo e($service->id); ?>"><?php echo e($service->category_name); ?></a>
              ...
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <?php $__currentLoopData = location();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <a href="javascript:void(0);" class="dropdown-item"><?php echo e($location->name); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </div>
              </div>
            </div> -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item <?php echo e(($segment1 == 'blog-list') ? 'active' : ''); ?>">
              <a class="nav-link" href="<?php echo e(route('blog-list')); ?>">Blog</a>
            </li>
            <li class="nav-item <?php echo e(($segment1 == 'contactus') ? 'active' : ''); ?>">
              <a class="nav-link" href="<?php echo e(route('contactus')); ?>">Contact Us</a>
            </li>
            
            <li class="nav-item <?php echo e(($segment1 == 'aboutus') ? 'active' : ''); ?>">
              <a class="nav-link" href="<?php echo e(route('aboutus')); ?>">About Us</a>
            </li>
            <?php if(Auth::check() && Auth::user()->role == '1'): ?>
              <li class="user-nav-section"><a href="<?php echo e(route('appointments')); ?>">
                <figure>
                <?php if(empty(profile_image()->image)): ?>
            ...
            <?php else: ?>
              <li class="nav-item">
                <a class="nav-link  btn btn-yellow" href="<?php echo e(route('login')); ?>">Login</a>
              </li>
              <li class="nav-item">
                <a class="nav-link btn btn-green" href="<?php echo e(route('registration')); ?>">Signup</a>
              </li>
            <?php endif; ?>
          </ul>
        </div>
...
$('.open_modal').click(function(){ 
   ...
   $('#select_subcat').attr('action',"<?php echo e(url('servicedetail')); ?>/"+btoa(id));
...
<?php $__env->stopSection(); ?>               <?php /**PATH /home/ogaworkmen/public_html/resources/views/frontend/header.blade.php ENDPATH**/ ?>