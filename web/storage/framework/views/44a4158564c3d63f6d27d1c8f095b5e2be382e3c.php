...
<body style="height: 100%; background-color:#fff;">
   <table style="width: 100%;">
     <tr>
       ...
       <th style="text-align: right;padding-right: 30px;"><img src="<?php echo e(asset('public/logo.jpg')); ?>" style="max-width: 340px;"></th>
     </tr>
   </table>
  ...
  <table style="width: 100%;padding: 20px 10px; font-family: 'Josefin Sans'; border-bottom: 1px solid #fff; margin-bottom: 10px;">
    <tr style="justify-content: space-between; padding: 0px 20px;">
        <th>
          <span style="text-align: left; display: block;margin-bottom: 10px;border-bottom: 2px solid #3f5960">
             ...
             <h5 style="margin: 0px; padding-bottom: 5px; font-family: 'Josefin Sans'; font-size: 14px;"><?php echo e($service_book_id); ?></h5>
          </span>
          <span style="text-align: left;">
             <h6 style="margin: 0px; padding-bottom: 5px; font-family: 'Josefin Sans'; text-align: left;font-size:16px;">DATE OF ISSUE</h6>
             <h5 style="margin: 0px; padding-bottom: 5px; font-family: 'Josefin Sans'; font-size: 14px;"><?php echo e(date("F/j/Y")); ?></h5>
          </span>
        </th>
        <th style="">  
   ...
   <table style="border: 1px solid #9d7628; width: 100%; text-align: left; padding: 10px;  font-family: 'Josefin Sans';border-radius: 8px;  border-collapse: collapse;">
      ...
      <tbody>
        <tr style="font-family: 'Josefin Sans'; font-size: 14px;">
          <td style="padding: 10px;"><?php echo e($to_name); ?></td>
          <td style="padding: 10px;">#<?php echo e($print_data1); ?></td>
          <td style="padding: 10px;">Nigeria.500102</td>
        </tr>
         <tr style="font-family: 'Josefin Sans'; font-size: 14px;">
          <td style=";padding: 10px;"><?php echo e($address); ?></td>
          <td style="padding: 10px;"></td>
          <td style="padding: 10px;">09062000701,09062000702</td>
        </tr>
         <tr style="font-family: 'Josefin Sans'; font-size: 14px;">
          <td style="padding: 10px;"><?php echo e($to_email); ?></td>
          <td style="padding: 10px;"></td>
   ...
   <table style="border: 1px solid #65a4b4; width: 100%; text-align: left; padding: 10px; font-family: 'Josefin Sans';border-radius: 8px;  border-collapse: collapse; margin-top: 30px;">
      ...
      <tbody>  
       <?php $subtotal=0;  ?>
        <?php $__currentLoopData = $print_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr style="font-family: 'Josefin Sans'; font-size: 14px;  border-bottom: 1px solid #65a4b4;">
          <td style="padding: 10px;"><?php echo e($price_data->service_name); ?></td>
          <td style="padding: 10px;"> <?php echo e($price_data->cost); ?></td>
          <td style="padding: 10px;"><?php echo e($price_data->quantity); ?></td>
          <td style="padding: 10px;"><?php  $subtotal= $subtotal + $price_data->calculate_price; ?> <?php echo e($price_data->calculate_price); ?> </td>
        </tr>
   ...
   <table style="border: 1px solid #65a4b4; width: 100%; text-align: left; padding: 10px; font-family: 'Josefin Sans';border-radius: 8px;  border-collapse: collapse; margin-top: 30px;">
     <tr style="border: 1px solid #fff;">
      ...
      <tr>
         <th style="background: #5b97a6; color: #fff; padding-left: 15px; padding-top: 20px;"><?php echo e($to_name); ?></th>
         <th style="background: #3f5960; width: 500px; font-size: 14px; font-weight: 400; color: #fff; padding-top: 20px; padding-left: 20px;">SUBTOTAL=<?php echo e($subtotal); ?></th>
      </tr>
      <tr>
         <th style="background: #5b97a6; color: #fff; padding-left: 15px;"><?php echo e($user_alldata->phone_no,$user_alldata->whatsapp_no); ?></th>
         <th style="background: #3f5960; width: 500px; font-size: 14px; font-weight: 400; color: #fff; padding-left: 20px;">DISCOUNT 
          <?php if($print_data[0]->discount !== '0'): ?> 
         = <?php echo e($print_data[0]->discount); ?>

           <?php endif; ?>
         </th>
      </tr>
      <tr>
         <th style="background: #5b97a6; color: #fff; padding-left: 15px;"><?php echo e($address); ?></th>
         <th style="background: #3f5960; width: 500px; font-size: 14px; font-weight: 400; color: #fff; padding-left: 20px;">(VAT RATE) <?php echo e($print_data[0]->vat); ?> %</th>
      </tr>
      <tr>
      ...
      <tr>
         <th style="background: #5b97a6; color: #fff; padding-left: 15px;"><?php echo e($to_email); ?></th>
         <th style="background: #3f5960; width: 500px; font-size: 14px; font-weight: 400; color: #fff; padding-left: 20px;">TOTAL= <?php echo e($print_data1); ?></th>
      </tr>
   </table>

</body>
</html><?php /**PATH /home/ogaworkmen/public_html/resources/views/admin/request_booking/invoice.blade.php ENDPATH**/ ?>