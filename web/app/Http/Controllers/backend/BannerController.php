...
class BannerController extends CommonController{
    ...
    public function edit($id,Request $request){
        if($request->isMethod('post')){
            ...
            $banner_content          =   Banner::find(base64_decode($id));
            $banner_content->title_en   =   $request['title_en'];
            $banner_content->title_ar   =   $request['title_ar'];
            $banner_content->description_en =   $request['description_en'];
            $banner_content->description_ar =   $request['description_ar'];
            $banner_content->button_en   =   $request['button_en'];
            $banner_content->button_ar   =   $request['button_ar'];
            $banner_content->button_url   =   $request['button_url'];
