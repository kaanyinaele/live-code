        ...
        <div class="categories-Management account-manage-box">
          ...
          <div class="classic-tabs">
            <ul class="nav tabs-cyan" id="myClassicTab" role="tablist">
              <li class="nav-item">
                 <a class="nav-link waves-light active show" id="contact-tab-classic" data-toggle="tab" href="#contact-classic" role="tab" aria-controls="contact-classic" aria-selected="false">Requests({{$total_all_request}})</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link waves-light" id="profile-tab-classic" data-toggle="tab" href="#profile-classic" role="tab" aria-controls="profile-classic" aria-selected="false">Upcoming Booking({{$total_Upcoming_booking}})</a> 
              </li>
              <li class="nav-item">
                <a class="nav-link waves-light" id="follow-tab-classic" data-toggle="tab" href="#follow-classic" role="tab" aria-controls="follow-classic" aria-selected="false">Completed Booking ({!! $total_booked!!})</a>
              </li>
              <li class="nav-item">
                <a class="nav-link waves-light" id="awesome-tab-classic" data-toggle="tab" href="#awesome-classic" role="tab"
                  aria-controls="awesome-classic" aria-selected="false">Cancelled Bookings({{$total_cancel}})</a>
              </li>
              <li class="nav-item">
                <a class="nav-link waves-light" id="awesome-tab-classicc" data-toggle="tab" href="#awesome-classicc" role="tab" aria-controls="awesome-classicc" aria-selected="false">Current Bookings({{$total_current_booking}})</a>
              </li>
            </ul>
